...
void init_methods_cache(JNIEnv *env)
{
    ...
    mpv_MPVLib = FIND_CLASS("com/videompv/MPVLib");
    ...
    mpv_MPVLib_eventEndFile = env->GetStaticMethodID(mpv_MPVLib, "eventFileEnd", 
        "(ILjava/lang/String;)V"); // eventFileEnd(int, string?)
